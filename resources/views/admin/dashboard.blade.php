            ...
            <div class="card">
                ...
                <div class="comment-widgets scrollable">
                    ...
                    <div class="d-flex flex-row comment-row m-t-0">
                        <div class="p-2"><img src="admin/assets/images/users/1.jpg" alt="user" width="50"
                    ...
                    <div class="d-flex flex-row comment-row">
                        <div class="p-2"><img src="admin/assets/images/users/4.jpg" alt="user" width="50"
                                              class="rounded-circle"></div>
                    ...
                    <!-- Comment Row -->
                    <div class="d-flex flex-row comment-row">
                        <div class="p-2"><img src="admin/assets/images/users/5.jpg" alt="user" width="50"
                                              class="rounded-circle"></div>
                        <div class="comment-text w-100">
