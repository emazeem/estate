...
@section('content')
    ...
    <div class="row align-items-center">
        <div class="col-5">
            <h4 class="page-title">Service Slider</h4>
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Service Slider</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <button type="button" class="btn btn-sm btn-primary shadow-sm float-right add" ><i class="fa fa-plus-circle"></i> Service Slider</button>
                </div>
                <div class="card-body">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        InitTable('{{ route('services.slider.fetch')}}',columns,'{{csrf_token()}}');
        $(document).on('click', '.edit', function () {

            var id = $(this).attr('data-id');
            $.ajax({
                "url": "{{route('services.slider.edit')}}",
                type: "POST",
        ...
        $("#add_form").on('submit', (function (e) {
            ...
            $.ajax({
                url: "{{route('services.slider.store')}}",
                type: "POST",
        ...
        $(document).on('click', '.delete', function (e) {
            ...
            var route="{{route('services.slider.destroy')}}";
