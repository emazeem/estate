...
@section('content')
    ...
    <div class="row align-items-center">
        <div class="col-5">
            <h4 class="page-title">Residential Gallery</h4>
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Residential Gallery</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <button type="button" class="btn btn-sm btn-primary shadow-sm float-right add" ><i class="fa fa-plus-circle"></i> Residential Gallery</button>
                </div>
                <div class="card-body">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        InitTable('{{ route('residential.gallery.fetch')}}',columns,'{{csrf_token()}}');
        $(document).on('click', '.edit', function () {

            var id = $(this).attr('data-id');
            $.ajax({
                "url": "{{route('residential.gallery.edit')}}",
                type: "POST",
        ...
        $("#add_form").on('submit', (function (e) {
            ...
            $.ajax({
                url: "{{route('residential.gallery.store')}}",
                type: "POST",
        ...
        $(document).on('click', '.delete', function (e) {
            ...
            var route="{{route('residential.gallery.destroy')}}";
