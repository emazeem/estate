        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form" id="add_form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="edit_link_name" class="control-label">Link</label>
                        <input type="text" class="form-control" name=link_name id="edit_link_name">
                    </div>
                    <div class="form-group">
                        <label for="edit_link_url" class="control-label">URL</label>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        InitTable('{{ route('sliders.fetch')}}',columns,'{{csrf_token()}}');
        $(document).on('click', '.edit', function () {

            var id = $(this).attr('data-id');
            $.ajax({
                "url": "{{route('sliders.edit')}}",
                type: "POST",
                ...
                success: function (data) {
                    ...
                    $('#edit_link_name').val(data.link_name);
