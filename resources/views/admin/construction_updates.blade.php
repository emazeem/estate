...
@section('content')
    ...
    <div class="row align-items-center">
        <div class="col-5">
            <h4 class="page-title">Construction Update</h4>
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Construction Update</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <button type="button" class="btn btn-sm btn-primary shadow-sm float-right add" ><i class="fa fa-plus-circle"></i> Construction Update</button>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><i class="fa fa-plus-circle"></i> Construction Update</h4>
            ...
            <div class="modal-body">
                <form class="form" id="add_form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="edit_developments" class="control-label">Developments</label>
                        <select class="form-control" name="developments[]" style="width: 100%" multiple id="edit_developments">
                            @foreach($devs as $dev)
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        InitTable('{{ route('construction.update.fetch')}}',columns,'{{csrf_token()}}');
        $(document).on('click', '.edit', function () {

            var id = $(this).attr('data-id');
            $.ajax({
                "url": "{{route('construction.update.edit')}}",
                type: "POST",
        ...
        $("#add_form").on('submit', (function (e) {
            ...
            $.ajax({
                url: "{{route('construction.update.store')}}",
                type: "POST",
        ...
        $(document).on('click', '.delete', function (e) {
            ...
            var route="{{route('construction.update.destroy')}}";
