...
@section('content')
    ...
    <div class="row align-items-center">
        <div class="col-5">
            <h4 class="page-title">Residential Feature</h4>
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Residential Feature</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <button type="button" class="btn btn-sm btn-primary shadow-sm float-right add" ><i class="fa fa-plus-circle"></i> Residential Feature</button>
                </div>
                <div class="card-body">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><i class="fa fa-plus-circle"></i> Residential Feature</h4>
            ...
            <div class="modal-body">
                <form class="form" id="add_form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="edit_detail" class="control-label">Detail</label>
                        <input type="text" class="form-control" name="detail" id="edit_detail">
                    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        InitTable('{{ route('residential.feature.fetch')}}',columns,'{{csrf_token()}}');
        $(document).on('click', '.edit', function () {

            var id = $(this).attr('data-id');
            $.ajax({
                "url": "{{route('residential.feature.edit')}}",
                type: "POST",
        ...
        $("#add_form").on('submit', (function (e) {
            ...
            $.ajax({
                url: "{{route('residential.feature.store')}}",
                type: "POST",
        ...
        $(document).on('click', '.delete', function (e) {
            ...
            var route="{{route('residential.feature.destroy')}}";
